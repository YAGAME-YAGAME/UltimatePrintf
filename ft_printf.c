...
/*   Updated: 2023/12/28 15:26:02 by aamohame         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static size_t	ft_format(va_list args, char c)
{
	size_t	total_length;
	...
	if (c == 'c')
		...
		total_length += ft_print_lowerhex(va_arg(args, unsigned int));
	else if (c == 'X')
		total_length += ft_print_upperhex(va_arg(args, unsigned int));
	else if (c == '%')
